<div class="modal fade" name="semester-modal" data-backdrop="static" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form" name="semester-form" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <div class="form-group mb-0 pb-0">
                                ...
                                <input type="text" class="form-control form-control-solid" name="semesterName" required
                                       placeholder="Enter @lang('body.semester_name')"/>
                            </div>
                        </div>
                    </div>
