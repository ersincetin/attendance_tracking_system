...
<div class="card card-custom col-xxl-12">
    <div class="card-header flex-wrap border-0 pt-6 pb-0 mr-1 pr-1">
        ...
        <div class="card-toolbar">
            @if(!is_null($permissions) && isset($permissions['teacher']) && $permissions['student-affairs']['creating'] == 1)
                <a href="javascript:;" class="btn btn-light-primary font-weight-bolder" name="user-add-btn">
                    <i class="fas fa fa-user-plus"></i> @lang('body.student_affairs_add')
                </a>
            @endif
        </div>
    </div>
    <div class="card-body m-1 p-1">
        <div
            ...
            <table class="table table-striped table-hover" name="users_datatable" data-label="student-affairs">
                <thead>
                    <tr>
                        <th>#</th>
