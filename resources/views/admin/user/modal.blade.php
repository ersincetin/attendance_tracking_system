                ...
                <form class="form" name="user-form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-0 pb-0 row">
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                            <label>@lang('body.user_type'): <span class="text-danger">*</span></label>
                            <select class="form-control form-control-solid" name="userType">
                                <option value="0">@lang('body.choose')</option>
                                <option value="2">@lang('body.manager')</option>
                                <option value="3">@lang('body.assistant_principal')</option>
                            </select>
                        </div>
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
