                                ...
                                <ul class="menu-subnav">
                                    <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                        ...
                                        <div class="menu-submenu">
                                            ...
                                            <ul class="menu-subnav">
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="{{url('admin/settings/role')}}" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                    ...
                                    <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                        ...
                                        <div class="menu-submenu">
                                            ...
                                            <ul class="menu-subnav">
                                                ...
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="{{url('admin/settings/site_setting/week')}}" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                                        <span class="menu-text">@lang('body.active_weeks')</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div
                                ...
                                <ul class="navi navi-hover py-4">
                                    ...
                                    <li class="navi-item active">
                                        <a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="{{asset("media/svg/flags/218-turkey.svg")}}" alt=""/>
													</span>
                ...
                <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                    ...
                    <div class="text-dark order-2 order-md-1">
                        ...
                        <a href="http://keenthemes.com/metronic" target="_blank"
                           class="text-dark-75 text-hover-primary">ersincetin</a>
                    </div>
                    <!--end::Copyright-->
                </div>
                <!--end::Container-->
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="navi mt-2">
                    ...
                    <a href="javascript:;" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5"
                       name="logout">Sign Out</a>
                </div>
            </div>
        </div>
        <!--end::Header-->
